...
fun PizzaPartyScreen(navController: NavController, modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Button(
            onClick = { navController.navigate("first_screen") },modifier = Modifier.fillMaxWidth()) {
            Text(text ="Go to First Screen")

        }
        Button(
            onClick = { navController.navigate("app_screen") },modifier = Modifier.fillMaxWidth()) {
            Text(text ="Go to GPA App")
